...
******************************************************************/
//网上收集整理程序，只做参考，请自己进行源码分析，有问题可以发到慧净论坛上，慧净只提供硬件学习板，软件方面请自己//学习，谢谢。
...
LCD_PutString(40,40,"www.hlmcu.com",Red,Blue);                  ///前景颜色和背景颜色，可以直接预定义，也可以直接填入16进制数字
LCD_PutString(40,60,"I LOVE YOU HJMCU ",Blue2,Yellow);
LCD_PutString(10,80,"中国慧净电子科技有限公司",Magenta,Green);
LCD_PutString(40,100,"专业技术支持论坛",0x07e0,0xf800);
LCD_PutString(40,120,"专业开发板学习板",0x001f,0xf800);
